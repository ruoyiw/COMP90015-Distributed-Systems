...
public class SubscribeNewResourceThread extends Thread{
	private static final Logger logger = LogManager.getLogger(SubscribeNewResourceThread.class);
	private String name;
	...
	public SubscribeNewResourceThread(String name, String description, String uri, String channel,
			String owner, String[] tagsArray, BufferedWriter output, String id){
		this.name = name;
