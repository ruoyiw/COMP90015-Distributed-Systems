...
public class InsecureSubscribeSeverThread extends Thread{
	private JSONObject command;
	//private ServerRecordList ServerRecordList;
	private DataOutputStream output;
	private static final Logger logger = LogManager.getLogger(InsecureSubscribeSeverThread.class);
	private InsecureSubscribeNewServerThread isnst;

	public InsecureSubscribeSeverThread(JSONObject command, DataOutputStream output){
